          ...
          <div :key="currentPage" class="fade_wrapper">
            ...
            <li v-for="day in week" 
              ...
              <div class="day" 
                ...
                <span v-on:click="openModalDetail(event)" class="event_span">{{ event }}</span>
...
export default {
  ...
  methods: {
    ...
    openAddEvent(dayNumber){
      ...
      let dataInAdd = new Date(this.year, this.currentPage, dayNumber)
      console.log(dataInAdd)
    	bus.$emit('changeModalWindowAdd', this.modalWindowAdd);
   		bus.$emit('dataInAdd', dataInAdd);
    },
